      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-red-900/20 overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="p-8 sm:p-10">
          <div className="mb-8 text-center">
            <h2 className={`${primaryFontBold.className} text-background text-2xl`}>Bienvenido</h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-background/20 focus:border-background transition-all font-medium"
                  value={email}
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                ...
                <a href="/password" className={`${primaryFontRegular.className} text-xs font-bold text-background hover:text-red-700 transition-colors`}>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-500">
              ...
              <Link href="/auth/register" className="font-bold text-background hover:underline transition-colors">
                Solicitar Acceso
              </Link>
            </p>
          </div>
