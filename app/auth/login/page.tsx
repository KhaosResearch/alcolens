...
export default function LoginPage() {
  ...
  return (
    <div className={`${primaryFontRegular.className} min-h-screen flex flex-col justify-center items-center bg-background p-4 sm:p-6 font-sans`}>
      ...
      <div className="w-full max-w-md bg-card rounded-3xl shadow-2xl shadow-primary/20 overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="p-8 sm:p-10">
          <div className="mb-8 text-center">
            <h2 className={`${primaryFontBold.className} text-primary text-2xl`}>Bienvenido</h2>
            <p className={`${primaryFontRegular.className} text-primary text-sm mt-1`}>Inicie sesión para acceder al panel médico</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                ...
                <a href="/auth/login/password" className={`${primaryFontRegular.className} text-xs font-bold text-primary hover:text-red-700 transition-colors`}>
          ...
          <div className="mt-8 pt-6 border-t border-border text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/auth/register" className="font-bold text-primary hover:underline transition-colors">
                Solicitar Acceso
              </Link>
            </p>
          </div>
